...
CatalystX::RelatedClassRoles - apply roles to your Catalyst application-related classes
...
=head1 SYNOPSIS
    ...
    use base 'Catalyst';
    use Catalyst;
    use CatalystX::RelatedClassRoles;
...
CatalystX::RelatedClassRoles makes it easy for you to apply roles to all the
